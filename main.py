...
# Ship
    ...
    mat_transform = trans.translate(-0.1, -0.1, mat_transform)
    ...
    #mat_transform = trans.translate(tx+.05*(np.cos(Theta)-np.sin(Theta)), ty+.05*(np.cos(Theta)+np.sin(Theta)), mat_transform)
